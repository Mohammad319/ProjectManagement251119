...
namespace Persistence.Migrations
{
    ...
    [Migration("20260418084300_DB260326_4")]
    partial class DB260326_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Calculation.TemplateColumnEntity", b =>
                {
                    ...
                    b.HasIndex("TemplateId")
                        .IsUnique()
                        .HasDatabaseName("UX_TemplateColumns_TemplateId");

                    b.HasIndex("UpdatedBy");

                    b.HasIndex("TenantId", "TemplateId")
                        .HasDatabaseName("IX_TemplateColumns_Tenant_Template");

                    b.ToTable("TemplateColumns", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Calculation.TemplateColumnEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Calculation.TemplateEntity", "Template")
                        .WithOne("ColumnSettings")
                        .HasForeignKey("Domain.Entities.Calculation.TemplateColumnEntity", "TemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
