...
namespace ProjectManagement.Client.Services.Calculation
{
    ...
    {
        List<MhdContextMenuItem> BuildGeneralContextMenu(bool isAdmin = false);
        List<MhdContextMenuItem> BuildTaskContextMenu(TaskListMVVM item, Action remove, Action duplicate);
        List<MhdContextMenuItem> BuildResourceContextMenu(ResourceListMVVM item, int taskId, Action remove, Action duplicate);
    }
    ...
    {
        private MhdContextMenuItem NewMenuItem(string icon, string label, Func<Task>? onClick) =>
            new()
            {
                Label = label,
                IconHtml = icon,
        ...
        private MhdContextMenuItem NewMenuItem(string icon, string label, Action onClick) =>
            new()
            {
                Label = label,
                IconHtml = icon,
        ...
        public List<MhdContextMenuItem> BuildGeneralContextMenu(bool isAdmin = false)
        {
            var list = new List<MhdContextMenuItem>();
            var calculation = folderState.Calculation;

            MhdContextMenuItem newTaskItem = NewMenuItem(
                Icons.NewTask,
        ...
        public List<MhdContextMenuItem> BuildTaskContextMenu(TaskListMVVM item, Action remove, Action duplicate)
        {
        ...
        private List<MhdContextMenuItem> BuildMultiTaskContextMenu(TaskListMVVM item, Action remove) =>
        [
            NewMenuItem(
                Icons.Delete,
                ResourceApp.delete,
        ...
        public List<MhdContextMenuItem> BuildResourceContextMenu(
