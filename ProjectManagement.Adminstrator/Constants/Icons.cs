namespace ProjectManagement.Adminstrator.Constants;
...
public static class Icons
  ...
  <polyline points='15 18 9 12 15 6' />
        ...
        public const string EyeIcon = @$"<svg {SVGHeader} fill='none' stroke='currentColor'
     stroke-width='2' stroke-linecap='round' stroke-linejoin='round'>
  <path d='M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7z'/>
  <circle cx='12' cy='12' r='3'/></svg>";
        public const string EyeOffIcon = @$"<svg {SVGHeader} fill='none' stroke='currentColor'
     stroke-width='2' stroke-linecap='round' stroke-linejoin='round'>
  <path d='M17.94 17.94A10.94 10.94 0 0 1 12 19c-7 0-11-7-11-7a17.8 17.8 0 0 1 5.06-5.94'/>
  <path d='M1 1l22 22'/><path d='M9.53 9.53A3.5 3.5 0 0 0 14.47 14.47'/></svg>";
