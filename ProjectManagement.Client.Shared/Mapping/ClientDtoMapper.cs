    ...
    public static class ClientDtoMapper
    {
        ...
        public static ApplicationModel ToApplicationModel(this ApplicationDTO dto)
        {
            ...
            return new ApplicationModel
            {
                ...
                Data = new ApplicationDataModel
                {
                    ...
                    LinkType = dto.Data?.LinkType ?? "Kalkyl",
                    AllDepartments = dto.Data?.AllDepartments ?? true,
                    RequiredBeforeOffer = dto.Data?.RequiredBeforeOffer ?? false,
                    SortOrder = dto.Data?.SortOrder ?? 0,
                    ...
                    Sections = dto.Data?.Sections?.Select(x => x.Clone()).ToList() ?? [],
        ...
        public static ApplicationDTO ToApplicationDto(this ApplicationModel model)
        {
            ...
            return new ApplicationDTO
            {
                ...
                Data = new ApplicationDataDTO
                {
                    ...
                    LinkType = model.Data?.LinkType ?? "Kalkyl",
                    AllDepartments = model.Data?.AllDepartments ?? true,
                    RequiredBeforeOffer = model.Data?.RequiredBeforeOffer ?? false,
                    SortOrder = model.Data?.SortOrder ?? 0,
                    ...
                    Sections = model.Data?.Sections?.Select(x => x.Clone()).ToList() ?? [],
        ...
        private static RowDTO ToRowDto(RowModel model)
        {
            return new RowDTO
            {
                ...
                SectionTitle = model.SectionTitle ?? string.Empty,
                HelpText = model.HelpText ?? string.Empty,
        ...
        private static AttributeDTO ToAttributeDto(AttributeModel model)
        {
            return new AttributeDTO
            {
                ...
                FieldKey = model.FieldKey ?? string.Empty,
                FieldTypeLabel = model.FieldTypeLabel ?? string.Empty,
