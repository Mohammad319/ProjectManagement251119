...
namespace ProjectManagement.Shared.DTO.App.Dataloader
{
    ...
    public class ResourceEXDto : ResourceDLBase
    {
        ...
        public void Backup()
        {
            ...
            Values.Add(Data.BaseCost.HasValue ? (double)Data.BaseCost.Value : 0d);
            ...
            return new Dictionary<string, double>
        {
            ...
            { "basecost", Data.BaseCost.HasValue ? (double)Data.BaseCost.Value : 0d },
            { "cap", Data.CapWaste },
            { "waste", Data.CapWaste },
        ...
        public void SetVariable(string name, double value)
        {
            switch (name.ToLower())
            {
                ...
                case "cost": Data.Cost = (decimal)value; break;
