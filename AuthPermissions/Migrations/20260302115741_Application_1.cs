...
{
    /// <inheritdoc />
    public partial class Application_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DB = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fax = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    ...
                    BuildNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tenants_TenantDatabases_TenantDBId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantDatabases_ConnectionString",
                table: "TenantDatabases",
                column: "ConnectionString",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TenantDatabases_Name",
                table: "TenantDatabases",
                column: "Name",
                unique: true);
