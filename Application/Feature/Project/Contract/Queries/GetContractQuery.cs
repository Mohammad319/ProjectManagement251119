...
namespace Application.Feature.Project.Contract.Queries
{
    ...
    public sealed record GetContractAdminListQuery() : IRequest<IReadOnlyList<LookupAdminListItemDto>>;

    public sealed class GetContractAdminListQueryHandler(ILookupStatusCommandService<ContractEntity> service)
        : IRequestHandler<GetContractAdminListQuery, IReadOnlyList<LookupAdminListItemDto>>
    {
        public Task<IReadOnlyList<LookupAdminListItemDto>> Handle(GetContractAdminListQuery request, CancellationToken cancellationToken)
